            ...
            Row(
              ...
              children: [
                GestureDetector(
                  ...
                  child: _SwipePageLabel(active: _pageIndex == 0, text: 'Front'),
                ),
                ...
                GestureDetector(
                  ...
                  child: _SwipePageLabel(active: _pageIndex == 1, text: 'Back'),
                ),
              ],
            ),
...
class MuscleMapScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const SafeArea(
        child: Padding(
          padding: EdgeInsets.fromLTRB(ZveltTokens.s3, ZveltTokens.s1, ZveltTokens.s3, ZveltTokens.s2),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              Expanded(
...
// ─────────────────────────────────────────────────────────────────────────────
// SWIPE PAGE HINT (Front / Back)
// ─────────────────────────────────────────────────────────────────────────────

class _SwipePageLabel extends StatelessWidget {
  const _SwipePageLabel({required this.active, required this.text});
  final bool active;
  final String text;
  ...
  Widget build(BuildContext context) {
    return Text(
      ...
      style: TextStyle(
        ...
        color: active ? ZveltTokens.brand : ZveltTokens.text3,
        fontSize: 12,
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: border ? Border.all(color: ZveltTokens.border) : null,
          ),
        ),
...
class MuscleMapSvg {
  static String _buildFrontSvg(Map<String, String> colors) {
    ...
    sb.write('</g>');
    final cadductors = colors['adductors'] ?? '#2A3840';
    ...
    sb.write('</g>');
    final cbiceps = colors['biceps'] ?? '#2A3840';
    ...
    sb.write('</g>');
    final ccalves = colors['calves'] ?? '#2A3840';
    ...
    sb.write('</g>');
    final cchest = colors['chest'] ?? '#2A3840';
    ...
    sb.write('</g>');
    final cdeltoids = colors['deltoids'] ?? '#2A3840';
    ...
    sb.write('</g>');
    final cforearm = colors['forearm'] ?? '#2A3840';
    ...
    sb.write('</g>');
    final cobliques = colors['obliques'] ?? '#2A3840';
    ...
    sb.write('</g>');
    final cquadriceps = colors['quadriceps'] ?? '#2A3840';
    ...
    sb.write('</g>');
    final ctrapezius = colors['trapezius'] ?? '#2A3840';
    ...
    sb.write('</g>');
    final ctriceps = colors['triceps'] ?? '#2A3840';
  ...
  static String _buildBackSvg(Map<String, String> colors) {
    ...
    sb.write('</g>');
    final cgluteal = colors['gluteal'] ?? '#2A3840';
    ...
    sb.write('</g>');
    final chamstring = colors['hamstring'] ?? '#2A3840';
    ...
    sb.write('</g>');
    final clowerBack = colors['lower-back'] ?? '#2A3840';
    ...
    sb.write('</g>');
    final cupperBack = colors['upper-back'] ?? '#2A3840';
