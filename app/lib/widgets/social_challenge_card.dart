...
class SocialChallengeCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final daysLeft =
        challenge.endsAt.difference(DateTime.now()).inDays.clamp(0, 9999);
    final scopeLabel =
        challenge.visibility == 'public' ? 'Public' : 'Friends only';
    final scopeIcon =
        challenge.visibility == 'public' ? AppIcons.globe : AppIcons.users;
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (challenge.targetHint != null &&
                    challenge.targetHint!.isNotEmpty) ...[
                  const SizedBox(height: ZveltTokens.s1),
                  Text(
                ...
                Wrap(
                  ...
                  children: [
                    Chip(
                      avatar:
                          Icon(scopeIcon, size: 16, color: ZveltTokens.text2),
                      label: Text(scopeLabel,
                          style: TextStyle(
                              fontSize: 11, color: ZveltTokens.text2)),
                      padding: EdgeInsets.zero,
                      visualDensity: VisualDensity.compact,
                      side: BorderSide(
                          color: ZveltTokens.border.withValues(alpha: 0.8)),
